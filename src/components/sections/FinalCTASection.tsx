...
import { ArrowRight, Star, Heart, BookOpen, LucideIcon } from 'lucide-react';
...
const FinalCTASection: React.FC = () => {
  ...
  return (
    <section 
      className="py-20 bg-gradient-to-br from-patriot-50 via-white to-navy-50 relative overflow-hidden"
    ...
    >
        ...
        <AnimatedSection>
          ...
          >
            ...
            >
              <Link 
                href="/admissions"
                aria-label="Start your journey with American Faith Academy today"
              >
          ...
          >
            ...
            >
              <Link 
                href="/contact"
                aria-label="Schedule a discovery call to learn more"
              >
            ...
            >
              <Link 
                href="/about"
                aria-label="Learn more about American Faith Academy"
              >
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            role="list"
            aria-label="Key features of American Faith Academy"
          >
      ...
      {/* Bottom Gradient */}
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-gray-100 to-transparent" aria-hidden="true" />
    </section>
  );
};
